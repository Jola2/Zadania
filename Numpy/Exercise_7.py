...
print('Iloczyn wartości:',np.prod(arr))
print('Kumulowany iloczyn wartości:',np.cumprod(arr), end='\n'+'-'*20+'\n')
...
print('Iloczyn wartości:',np.prod(arr,axis=1))
print('Kumulowany iloczyn wartości:',np.cumprod(arr,axis=1), end='\n'+'-'*20+'\n')
...
print('Iloczyn wartości:',np.prod(arr,axis=0))
print('Kumulowany iloczyn wartości:',np.cumprod(arr,axis=0))
